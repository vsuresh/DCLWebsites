<%@ Page language="c#" AutoEventWireup="true" MasterPageFile="~/SiteTournament.master" Inherits="Cricket.Offerings.paymentMisc" CodeFile="paymentDCL.aspx.cs" CodeFileBaseClass="Cricket.PageBase" %>
                        ...
                        <td valign="top" align="left">
                            ...
                            <div id="Div1" runat="server">
							    <table id="Table1" width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
							        <tr>
								        <td colSpan="2" class="title">Payment Form for DCL/DYCL/DWCL/DLCL
                                        </td>
							        </tr>
								    <tr>
									    <td align="center">
							        ...
							        <tr>
								        <td align="right"><span class="infoLabel">Player Name:</span>
								        </td>
								        <td>
