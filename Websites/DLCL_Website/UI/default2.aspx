<%@ Page Title="Home Page" Language="c#" MasterPageFile="~/Site.master" Inherits="Cricket._default" CodeFile="default.aspx.cs" CodeFileBaseClass="Cricket.PageBase" %>
    ...
    <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <table width="90" border="0" align="center" cellpadding="0" cellspacing="0" class="bodyoutline">
            <tr>
                ...
                <td align="center" valign="top">
                    <table width="900" border="0" cellpadding="0" cellspacing="10">
                        ...
                        <tr align="center" valign="top" width="600">
                            <a target="_self" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=NCD3BDZVDYK96" <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
                            ...
                            <td colspan="6">
                                ...
                                <div class="jcarousel-wrapper">
                                    <div class="jcarousel">
                                        <ul>
                                            <li><img src="/Images/dclpics2017/Slide1.JPG" alt="" width="850px" height="300"></li>
                                            <li><img src="/Images/dclpics2017/Slide2.JPG" alt="" width="850px" height="300"></li>
                                            <li><img src="/Images/dclpics2017/Slide3.JPG" alt="" width="850px" height="300"></li>
                                            <li><img src="/Images/dclpics2017/Slide4.JPG" alt="" width="850px" height="300"></li>
                                            <li><img src="/Images/dclpics2017/Slide5.JPG" alt="" width="850px" height="300"></li>
                                            <li><img src="/Images/dclpics2017/Slide6.JPG" alt="" width="850px" height="300"></li>
                                        </ul>
                                    </div>
