...
{
	/// <summary>
	/// Summary description for topBowlingER.
	/// </summary>
	public partial class topBowlingER : PageBaseTournament
	{
		...
		{
			SqlDataReader dr = m_bl.DataStatistics.getTopBowlingEconomyRate(tournamentId);
		...
		private void dgrid_bowling_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				Session["back_url"] = "topBowlingER.aspx";
