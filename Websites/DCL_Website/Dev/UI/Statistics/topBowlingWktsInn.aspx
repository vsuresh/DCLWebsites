<%@ Page Language="c#" MasterPageFile="~/SiteTournament.Master" Inherits="Cricket.Statistics.topBowlingWktsInn" CodeFile="topBowlingWktsInn.aspx.cs"
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:DataGrid ID="dgrid_bowling" runat="server" AllowCustomPaging="false" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="wickets" HeaderText="Wkts">
                                                    <HeaderStyle CssClass="rtColHeader2"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Right" Width="5%" CssClass="rtCellData"></ItemStyle>
                                                </asp:BoundColumn>
