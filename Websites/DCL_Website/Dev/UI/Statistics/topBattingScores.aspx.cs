...
{
	/// <summary>
	/// Summary description for topBattingScores.
	/// </summary>
	public partial class topBattingScores : PageBaseTournament
	{
		...
		{
			SqlDataReader dr = m_bl.DataStatistics.getTopBattingScores(tournamentId);
		...
		private void dgrid_batting_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				Session["back_url"] = "topBattingScores.aspx";
