                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            -->
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" class="titleNoLine">
                                                Spring 2012 Tournament Results
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
                                                <table id="_ctl0__ctl0_MainContent_MainContent_dgrid_awardsmain" border="1" 
                                                    bordercolor="#2d7c97" cellpadding="0" cellspacing="0" class="rtTable" 
                                                    rules="all" 
                                                    style="BORDER-BOTTOM-STYLE: solid; BORDER-BOTTOM-COLOR: #2d7c97; BORDER-TOP-COLOR: #2d7c97; BORDER-LEFT-STYLE: solid; WIDTH: 500px; BORDER-COLLAPSE: collapse; BORDER-TOP-STYLE: solid; BORDER-RIGHT-COLOR: #2d7c97; BORDER-RIGHT-STYLE: solid; BORDER-LEFT-COLOR: #2d7c97">
                                                    <tr>
                                                        <td class="rtColHeader2">
                                                            Award</td>
                                                        <td class="rtColHeader2">
                                                            Team Name</td>
                                                    </tr>
                                                    <tr class="rtRow1" style="BACKGROUND-COLOR: azure">
                                                        <td class="rtCellDataLeft" style="WIDTH: 50%; FONT-WEIGHT: bold">
                                                            Champions</td>
                                                        <td class="rtCellData" style="WIDTH: 50%; FONT-WEIGHT: bold">
                                                            VR Lions</td>
                                                    </tr>
                                                    <tr class="rtRow2" style="BACKGROUND-COLOR: lightyellow">
                                                        <td class="rtCellDataLeft" style="WIDTH: 50%; FONT-WEIGHT: bold">
                                                            RunnerUp</td>
                                                        <td class="rtCellData" style="WIDTH: 50%; FONT-WEIGHT: bold">
                                                            Dallas Tigers</td>
                            ...
                            <!--
                            <span class="subtitle" style="color:Navy">
                            Please note that Kuljit will be out of action for a few weeks and won't be able to respond to your emails and phone calls.
                            <br />Please contact Zia/Krishna (or other organizers) with your queries going forward!
                            </span>
                            -->
