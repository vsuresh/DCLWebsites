...
<body onload="document.Paypal.submit();">
    <form id="Paypal" name="Paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input type="hidden" name="return" value="http://www.youthcricket.net/PayPalDCL/paymentSuccess.aspx" />
	    <input type="hidden" name="cancel_return" value="http://www.youthcricket.netDCL/Paypal/paymentCancel.aspx" />
	    <input type="hidden" name="notify_url" value="http://www.youthcricket.net/PayPalDCL/paymentSuccess.aspx" />
    </form>
</body>
</html>
