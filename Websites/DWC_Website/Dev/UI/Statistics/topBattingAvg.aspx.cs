...
{
	/// <summary>
	/// Summary description for topBattingAvg.
	/// </summary>
	public partial class topBattingAvg : PageBaseTournament
	{
		...
		{
			SqlDataReader dr = m_bl.DataStatistics.getTopBattingAverages(tournamentId);
		...
		private void dgrid_batting_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				Session["back_url"] = "topBattingAvg.aspx";
