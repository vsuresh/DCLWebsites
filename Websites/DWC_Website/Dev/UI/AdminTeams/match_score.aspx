						...
						<td valign="top" align="left">
                            ...
                            <table id="TableCustom" width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnAddBonus" TabIndex="26" runat="server" Text="Bonus Points" CssClass="btnAdmin"
                                            OnClick="btnAddBonus_Click"></asp:Button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        (Add bonus points and click on submit to apply the bonus points)
                                        <br />
                                        <br />
