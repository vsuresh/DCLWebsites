<%@Page Language="c#" MasterPageFile="~/Site.master" Inherits="Cricket.Main.grounds" CodeFile="grounds.aspx.cs" CodeFileBaseClass="Cricket.PageBase" %>
                                        ...
                                        <tr>
                                            <td width="20%">
                                                <asp:DataGrid ID="dgrid_grounds" runat="server" CssClass="rtTable" AllowCustomPaging="false"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundColumn DataField="ground_id" HeaderText="" visible="false">
                                                            <ItemStyle HorizontalAlign="left" Width="0%" CssClass="rtCellData">
                                                            </ItemStyle>
                                                        </asp:BoundColumn>
                                                        <asp:HyperLinkColumn DataTextField="name" HeaderText="" DataNavigateUrlField="ground_id" DataNavigateUrlFormatString="/Main/grounds.aspx?groundId={0}">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <br />
                                                        <br />
                                                        <asp:Image id="imageGround" runat="server" Width="500" Height="400" ImageUrl="" />
                                                    </td>
                                                </tr>
                                            </table>
                                            </td>
