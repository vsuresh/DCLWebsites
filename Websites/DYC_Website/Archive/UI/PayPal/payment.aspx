...
<body onload="document.Paypal.submit();">
    <form id="Paypal" name="Paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
	    ...
	    <input type="hidden" name="business" value="tenali427@gmail.com" /> 
        <input type="hidden" name="invoice" value="<%=Session["Paypal_OrderId"]%>" />
	    <input type="hidden" name="no_note" value="0" /> 
        <input type="hidden" name="currency_code" value="USD" />
	    <input type="hidden" name="lc" value="0" />
        <input type="hidden" name="return" value="http://youthcricket.net/PayPal/paymentSuccess.aspx" />
	    <input type="hidden" name="cancel_return" value="http://youthcricket.net/Paypal/paymentCancel.aspx" />
	    <input type="hidden" name="notify_url" value="http://youthcricket.net/PayPal/paymentSuccess.aspx" />
    </form>
</body>
</html>
