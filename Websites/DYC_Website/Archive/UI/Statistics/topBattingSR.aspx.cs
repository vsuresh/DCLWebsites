...
{
	/// <summary>
	/// Summary description for topBattingSR.
	/// </summary>
	public partial class topBattingSR : PageBaseTournament
	{
		...
		{
			SqlDataReader dr = m_bl.DataStatistics.getTopBattingStrikeRate(tournamentId);
		...
		private void dgrid_batting_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				Session["back_url"] = "topBattingSR.aspx";
