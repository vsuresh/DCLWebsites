...
{
	/// <summary>
	/// Summary description for topBowlingWktsInn.
	/// </summary>
	public partial class topBowlingWktsInn : PageBaseTournament
	{
		...
		{
			SqlDataReader dr = m_bl.DataStatistics.getTopBowlingBestInning(tournamentId);
		...
		private void dgrid_bowling_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				Session["back_url"] = "topBowlingWktsInn.aspx";
