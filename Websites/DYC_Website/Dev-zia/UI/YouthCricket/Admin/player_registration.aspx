                                    ...
                                    <td align="center" colspan="2">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="created_dt" HeaderText="created_dt" 
                                                    SortExpression="created_dt" />
                                            </Columns>
                                        </asp:GridView>
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:dallascricketleague %>" 
                                            SelectCommand="SELECT * FROM [player_registration] WHERE ([tournament_id] = @tournamentID) order by created_dt desc">
                                               <SelectParameters>
                                                 <asp:ControlParameter Name="tournamentID" Type="Int32" ControlID="ddlTournament" PropertyName="SelectedValue"></asp:ControlParameter>
                                               </SelectParameters>
                                        </asp:SqlDataSource>
