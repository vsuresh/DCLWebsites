					...
					<tr>
						<td valign="top" align="left">
                            ...
                            <table id="TableCustom" width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    <td align="right">
                                        <span class="infoLabel">Umpiring:</span>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtUmpire1" runat="server" Width="250px" MaxLength="255"></asp:TextBox>
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="txtUmpire2" runat="server" Width="250px" MaxLength="255"></asp:TextBox>
                                        <br />
                                        <!--
                                        <asp:DropDownList runat="server" ID="ddlUmpireTeam" Visible="false">
                                        </asp:DropDownList>
                                        <asp:DropDownList runat="server" ID="ddlUmpireTeam2" Visible="false">
                                        </asp:DropDownList>
                                        <br />
                                        -->
                                ...
                                <tr>
                                    <td align="right">
                                        <span class="infoLabel">Supervisors:</span>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSupervisor1" runat="server" Width="250px" MaxLength="255"></asp:TextBox>
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="txtSupervisor2" runat="server" Width="250px" MaxLength="255"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
