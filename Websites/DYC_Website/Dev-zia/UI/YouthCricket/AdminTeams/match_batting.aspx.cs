	...
	public partial class match_batting : PageBaseAdmin
	{
		...
		protected void btnSubmit_Click(object sender, System.EventArgs e)
		{
			if (Page.IsValid)
			{
				...
				if (m_nPlayerId > 0)
				{
					m_bl.setMatchBatting(false, m_nTournamentId, m_nMatchId, m_nBattingTeamId, nPlayerId, strMatchStatus, nFielderId, nBowlerId, nMatchRuns, nMatchBalls, fStrikeRate, nMatchFours, nMatchSixes);
				}
				else
				{
					if (dgrid_batting.Items.Count < 11)
						m_bl.setMatchBatting(true, m_nTournamentId, m_nMatchId, m_nBattingTeamId, nPlayerId, strMatchStatus, nFielderId, nBowlerId, nMatchRuns, nMatchBalls, fStrikeRate, nMatchFours, nMatchSixes);
				}
		...
		private void dgrid_batting_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			else if (e.CommandName == "Delete")
			{
				...
				m_bl.deletePlayerBatting(m_nTournamentId, m_nMatchId, nPlayerId);
