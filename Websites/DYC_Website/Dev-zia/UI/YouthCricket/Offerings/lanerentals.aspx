...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
 ...
 collapse;width:444pt" width="591">
                                                            ...
                                                            <tr height="20">
                                                                <td class="auto-style2" height="20" width="298"> Friday and Weekend Option Only</td>
                                                              <!--  <td class="auto-style2" width="293">Weekday Option <strong>(ONLY with Bowling Machine)</strong></td> -->
                                                            </tr>
                                                            <tr height="20">
                                                                <td height="20"></td>
                                                                <td></td>
                                                         ...
                                                         <!--       <td class="auto-style1">Timings</td> -->
                                                            ...
                                                            <tr height="20">
                                                                <td height="20">Friday: 8:30pm till 12:00 midnight.<span style="mso-spacerun:yes">&nbsp;</span></td>
                                                          <!--          <td>Monday to Thursday: 9am till 11pm</td> -->
                                                            </tr>
                                                            <tr height="20">
                                                                <td height="20">Saturday: 4:30pm till 11:30 midnight</td>
                                                         <!--           <td>Friday: 9am till 7pm (Length of each Lanes: <strong>70 ft.</strong>)</td> -->
                                                            </tr>
                                                            <tr height="20">
                                                                <td height="20">Sunday: 4:30pm till 11:30 midnight</td>
                                                                <td></td>
                                                            </tr>
                                                            <tr height="20">
                                                                <td height="20">&nbsp;</td>
                                                    ...
                                                    <table id="TableCustom" width="96%" border="0" align="left" cellpadding="2" cellspacing="2">
                                                        <tr>
                                                            <td align="left" colspan="2"><b><span class="auto-style4">Lane Reservation</span><br />
                                                                <br />
                                                                </b>To Reserve the LANES, please send an email to <span class="auto-style4"><strong>icricketa@gmail.com</strong></span> and after availability confirmation, use the PayPal button below to make the payment. Your reservation is confirmed only after payment is received.
                                                                <br />
                                                                <br />
                                                                <span class="auto-style5">(Reservations will be updated on website until 
                                                                our lane booking solution becomes available.)&nbsp; </span>
                                                                <hr />
                                                                <br /></td>
                                                        </tr>
                                                        <tr>
							                            ...
							                            <tr>
								                            ...
								                            <td>
                                                                I, hereby state that I have read all the Rules, Regulations of Discipline &amp; Instructions and I promise to comply with all the rules &amp; regulations and discipline of the Indoor Cricket Academy. I am sending my child / ward or using the facilities with my full responsibility!
                                                                <br />
										        ...
										        Text="Pay via PayPal" OnClick="btnSubmit_Click"></asp:button>
                                                                <br>
                                                                <br>
                                                                <span class="infoData">You will be taken to the secure PayPal website! 
