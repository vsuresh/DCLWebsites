	...
	public partial class match_bowling : PageBaseAdmin
	{
		...
		protected void btnSubmit_Click(object sender, System.EventArgs e)
		{
			if (Page.IsValid)
			{
				...
				if (m_nPlayerId > 0)
				{
                    m_bl.setMatchBowling(false, tournamentId, m_nMatchId, m_nBowlingTeamId, nPlayerId, flMatchOvers, nMatchMaiden, nMatchRuns, nMatchWickets, nMatchWides, nMatchNos);
				}
				else
				{
					if (dgrid_bowling.Items.Count < 11)
                        m_bl.setMatchBowling(true, tournamentId, m_nMatchId, m_nBowlingTeamId, nPlayerId, flMatchOvers, nMatchMaiden, nMatchRuns, nMatchWickets, nMatchWides, nMatchNos);
				}
		...
		private void dgrid_bowling_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			else if (e.CommandName == "Delete")
			{
                ...
                m_bl.deletePlayerBowling(tournamentId, m_nMatchId, nPlayerId);
