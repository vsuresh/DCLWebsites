	...
	public partial class tournament : PageBaseAdmin
	{
		...
		protected void btnSubmit_Click(object sender, System.EventArgs e)
		{
			if (Page.IsValid)
			{
				...
				if (id <= 0)
				{
                    m_bl.createTournament(txtName.Text, txtDesc.Text, txtStartDate.Text, txtEndDate.Text, toInt(txtOvers.Text), toInt(txtFees.Text), txtRegStartDate.Text, txtRegEndDate.Text, sqlEncode(editorRegInfo.Content), sqlEncode(editorFormat.Content));
				...
				{
                    m_bl.setTournamentData(int.Parse(lblId.Text), txtName.Text, txtDesc.Text, txtStartDate.Text, txtEndDate.Text, toInt(txtOvers.Text), toInt(txtFees.Text), txtRegStartDate.Text, txtRegEndDate.Text, sqlEncode(editorRegInfo.Content), sqlEncode(editorFormat.Content));
				}
			}
		}
