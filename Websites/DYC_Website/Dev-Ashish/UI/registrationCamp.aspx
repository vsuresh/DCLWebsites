							    ...
							    <table id="TableCustom" width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
							        <tr>
								        <td align="left" colSpan="2">
									        ...
									        <asp:label id="lblTournamentID" runat="server" Width="600px" Visible="false"></asp:label>
									        <br />
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                ...
                                                InsertCommand="INSERT INTO player_registration(g2_email2, g2_email1, g2_phone_work, g2_male_female, g2_last_name, g2_first_name, g1_volunteer, g1_email2, g1_email1, g1_phone_work, g1_phone_cell, g1_male_female, g1_last_name, g1_first_name, comments, address, shirt_size, skill_level, school_grade, school_name, phone_cell, phone_home, dob, male_female, last_name, first_name, g2_phone_cell, tournament_id) VALUES ('', @g2_email1, @g2_phone_work, @g2_male_female, @g2_last_name, @g2_first_name, @g1_volunteer, '', @g1_email1, @g1_phone_work, @g1_phone_cell, @g1_male_female, @g1_last_name, @g1_first_name, @comments, @address, @shirt_size, @skill_level, @school_grade, @school_name, @phone_cell, @phone_home, @dob, @male_female, @last_name, @first_name, @g2_phone_cell, @tournamentID)">

                                               <InsertParameters>
                                                 <asp:ControlParameter Name="tournamentID" Type="Int32" ControlID="lblTournamentID" PropertyName="Text"></asp:ControlParameter>
                                               </InsertParameters>
