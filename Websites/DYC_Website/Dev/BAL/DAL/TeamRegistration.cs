...
namespace Cricket.DAL.TeamRegistration
{
	...
	public class CreateTeamRegistration : Command
	{
		...
		{
            m_cmd.CommandText = "insert into team_registration (RegistrationID,tournament_id, rec_id, team_id, name, contact1_name, contact1_title, contact1_phone, contact1_email, contact2_name, contact2_title, contact2_phone, contact2_email, location, comments, created_dt, order_id, age_category, club_state, fees) " +
                "values (@RegistrationID,@tournament_id, @rec_id, @team_id, @name, @contact1_name, @contact1_title, @contact1_phone, @contact1_email, @contact2_name, @contact2_title, @contact2_phone, @contact2_email, @location, @comments, GetDate(), @order_id, @age_category, @club_state, @fees) ";
            ...
            addParmText("age_category");
            addParmText("club_state");
            addParmInt("fees");
        }
	}
