                                    ...
                                    <td colspan="2" align="center">
                                        ...
                                        <asp:DataGrid ID="dgrid_schedule" runat="server" CssClass="rtTable" AllowCustomPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="umpire1" HeaderText="Umpiring1">
                                                    <HeaderStyle CssClass="rtColHeader2"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="rtCellData"></ItemStyle>
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="umpire2" HeaderText="Umpiring2">
                                                    <HeaderStyle CssClass="rtColHeader2"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="rtCellData"></ItemStyle>
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="supervisor1" HeaderText="Supervisor1">
                                                    <HeaderStyle CssClass="rtColHeader2"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="rtCellData"></ItemStyle>
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="supervisor2" HeaderText="Supervisor1">
                                                    <HeaderStyle CssClass="rtColHeader2"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="rtCellData"></ItemStyle>
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="winning_team" HeaderText="Winner" Visible="false">
                                                    <HeaderStyle CssClass="rtColHeader2"></HeaderStyle>
