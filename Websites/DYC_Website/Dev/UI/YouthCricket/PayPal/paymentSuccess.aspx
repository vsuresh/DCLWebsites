<%@ Page Language="C#" MasterPageFile="~/SiteTournament.Master" AutoEventWireup="true" CodeFile="paymentSuccess.aspx.cs" Inherits="Cricket.Paypal.paymentSuccess" %>
                            ...
                            <table id="TableCustom" width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    <td colspan="2">
                                            ...
                                            <br />
                                            <br />
                                            If you were trying to register for a tournament or coaching program, your registration has been accepted!
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
