...
{
	/// <summary>
	/// Summary description for topBowlingAvg.
	/// </summary>
	public partial class topBowlingAvg : PageBaseTournament
	{
		...
		{
			SqlDataReader dr = m_bl.DataStatistics.getTopBowlingAverage(tournamentId);
		...
		private void dgrid_bowling_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				Session["back_url"] = "topBowlingAvg.aspx";
