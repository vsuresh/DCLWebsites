	...
	public partial class schedule : PageBaseTournament
	{
		...
		protected void loadData()
		{
			...
			while(dr.Read())
			{
                ...
                string umpiringText = "";
                string umpiringText1 = dr["umpire1"] as string;
                string umpiringText2 = dr["umpire2"] as string;
                ...
                string supervisors = "";
                string supervisor1 = dr["supervisor1"] as string;
                string supervisor2 = dr["supervisor2"] as string;
                if (!string.IsNullOrEmpty(umpiringText1) || !string.IsNullOrEmpty(umpiringText2))
                {
                    if (string.IsNullOrEmpty(supervisor1))
                        supervisors = supervisor2;
                    else if (string.IsNullOrEmpty(supervisor2))
